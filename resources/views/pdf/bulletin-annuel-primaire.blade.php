...
<style>
  * { font-family: 'DejaVu Sans', Arial, sans-serif; font-size: 8.5pt; }
  ...
  .header { text-align: center; border-bottom: 3px solid #1e40af; padding-bottom: 8px; margin-bottom: 12px; }
  .title { font-size: 13pt; font-weight: bold; color: #1e40af; }
  .subtitle { font-size: 9pt; color: #3b82f6; margin-top: 2px; }
  .student-info { background: #eff6ff; padding: 8px 10px; border-radius: 4px; margin-bottom: 12px; border: 1px solid #bfdbfe; }
  .student-info table { width: 100%; border-collapse: collapse; }
  .student-info td { padding: 2px 6px; }
  table.grades { width: 100%; border-collapse: collapse; margin-bottom: 4px; }
  table.grades thead tr { background: #1e40af; color: white; }
  table.grades th { padding: 4px 5px; border: 1px solid #1d4ed8; text-align: center; font-size: 7.5pt; }
  table.grades td { padding: 3px 5px; border: 1px solid #dbeafe; vertical-align: middle; }
  table.grades tbody tr:nth-child(even) { background: #f0f7ff; }
  .subject-block { margin-top: 8px; }
  .subject-header { background: #1e40af; color: white; font-weight: bold; padding: 4px 8px; font-size: 9pt; }
  .subtotal-row { background: #dbeafe; font-weight: bold; }
  .summary-table { width: 100%; border-collapse: collapse; margin-top: 10px; border: 2px solid #1e40af; border-radius: 4px; overflow: hidden; }
  .summary-table td { padding: 5px 10px; border-bottom: 1px solid #bfdbfe; }
  .summary-header { background: #1e40af; color: white; font-weight: bold; font-size: 9.5pt; }
  .annual-avg { font-size: 14pt; font-weight: bold; color: #1e40af; text-align: center; }
